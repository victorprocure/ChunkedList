...
internal sealed class EmptyChunkedList<T> : ChunkedList<T>
{
    ...
    internal EmptyChunkedList(IEqualityComparer<T>? equalityComparer = default) : base(true, equalityComparer) { }
    ...
    private protected override T GetAtIndex(int index) => default!;
    ...
    private protected override void SetAtIndex(int index, T item) => throw _unableToExecute;
